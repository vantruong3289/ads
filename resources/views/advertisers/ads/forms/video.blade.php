<div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
        <div class="px-4 lg:px-0">
            <h3 class="text-base font-semibold leading-6 text-gray-900">Video</h3>
                ...
                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div>
                        ...
                        <div class="mt-2 grid grid-cols-2 gap-4">
                            @if ($ads->getFirstMediaUrl('video'))
                                <video src="{{ $ads->getFirstMediaUrl('video') }}" controls class="rounded-md"></video>
                            @endif

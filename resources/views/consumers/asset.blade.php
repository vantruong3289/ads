                            ...
                            <dl>
                                @foreach ($assets as $asset)
                                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        <dt class="text-sm font-medium text-gray-500">{{ $asset->brand->name }}</dt>
                                        <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">@money($asset->money, $asset->currency)</dd>
                                    </div>
                                @endforeach
                            </dl>
                        </div>
